...
class Connection:
    ...
    def getDebugData(self):
        ...
        if self.ip_type == "v4":
            ...
            _request_flow["src"] = ipaddress.ip_address( _request_flow["sourceIPv6Address"] ).compressed
            del _request_flow['sourceIPv6Address']
            _request_flow["dest"] = ipaddress.ip_address( _request_flow["destinationIPv6Address"] ).compressed
            del _request_flow['destinationIPv6Address']
